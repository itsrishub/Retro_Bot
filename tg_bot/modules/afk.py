...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("{} has gone off for a while ! ".format(update.effective_user.first_name))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        update.effective_message.reply_text("{} has come back on !".format(update.effective_user.first_name))
